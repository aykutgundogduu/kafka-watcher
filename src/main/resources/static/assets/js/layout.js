...
(function () {
    ...
    if (sessionStorage.getItem('defaultAttribute')) { console.log("called defaultAttribute");
        ...
        Object.entries(attributesValue).forEach(function(key) {
          ...
          /*console.log(sessionStorage.getItem('defaultAttribute'));
          console.log(JSON.stringify(CurrentLayoutAttributes));*/
